...
class ZonesTest extends TestCase
{
    public function testAddZone()
    {
        ...
        $createresponse = $this->getPsr7JsonResponseForFixture('Endpoints/createPageRule.json');

        $createmock = $this->getMockBuilder(Adapter::class)->disableOriginalConstructor()->getMock();
        $createmock->method('post')->willReturn($createresponse);
        ...
        $newzones = new Zones($createmock);
        $newzones->addZone('example.com', true, '01a7362d577a6c3019a474fd6f485823');
        $this->assertEquals('9a7806061c88ada191ed06f989cc3dac', $newzones->getBody()->result->id);
    }
